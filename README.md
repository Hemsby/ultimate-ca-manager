...
- **TSA (RFC 3161)** -- timestamp authority with configurable policy OID; signs with the CA certificate or a **dedicated end-entity signing certificate** picked from issued certificates (timeStamping EKU required, renewals followed automatically, issuer chain embedded in tokens, strict dedicated-signer mode)
